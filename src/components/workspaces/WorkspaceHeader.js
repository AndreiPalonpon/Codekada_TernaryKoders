  ...
  return (
    <header className="h-16 bg-white border-b border-slate-200 flex items-center px-8 justify-between shrink-0 shadow-sm z-10">
      ...
      <div className="w-1/3 flex items-center justify-end gap-5">
        ...
        {/* Team Collaboration Module - Hidden as requested */}
        {false && (
            ...
            <div className="relative">
              ...
              {isShareMenuOpen && (
                <>
                  ...
                  <div className="absolute top-full right-0 mt-2 w-80 bg-white rounded-xl shadow-xl border border-slate-200 p-4 z-50 animate-in slide-in-from-bottom-2 fade-in duration-200">
